...
while (true):
   ...
   $res = mysql_query("select * from counters where name='urls' limit 1");
   ...
   echo "Last URL processed had tweet id $start_id\n";
   ...
   $res = mysql_query("select * from tweet_urls where tweet_id>$start_id order by tweet_id limit 100");
   ...
   $res = mysql_query("update counters set last_id=$last_id,records=$num_urls,processed=$processed,skipped=$donebefore,added=$newrecs,last_date=now() where name='urls'");
